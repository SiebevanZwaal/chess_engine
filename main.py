...
# TODO Let player choose starting color
# TODO fix score
# TODO let player choose piece when pawn crosses map
            ...
            if move in board.legal_moves:
                ...
                if board.is_checkmate():
                    if not whitesturn:
                        ...
                        score_label =update_score(score_label)
...
def refresh_board(window,frame,fen,scorelabel):
    ...
    window.bind("<Button-1>",func=lambda event: make_a_move(event,window,frame,scorelabel))
    window.bind("<Button-3>",empty_first_request)
